...
df = pd.read_csv(r"C:/Users/OliverNowakbtelligen/OneDrive - b.telligent group/Desktop/GCP ML Demo/train.csv")
...
# Creating histograms
plt.figure(figsize=(10, 4))
sns.histplot(df['Purchase'], bins=30, kde=True, color='skyblue')  # Adjust bins and other parameters as needed
