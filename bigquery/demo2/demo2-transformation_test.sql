...
/**
CREATE TABLE `bt-int-ml-specialization.demo2.black-friday-test-new`
AS
SELECT *
...
UPDATE `bt-int-ml-specialization.demo2.black-friday-test-new`
SET
...
SELECT Count(*) FROM `bt-int-ml-specialization.demo2.black-friday-test-new`
...
ALTER TABLE `bt-int-ml-specialization.demo2.black-friday-test-new`
...
WHERE
table_name = 'black-friday-test-new';
...
-- Show columns
SELECT * FROM `bt-int-ml-specialization.demo2.black-friday-test-new`;
